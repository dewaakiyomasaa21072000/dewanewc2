...
\033[0;34mOI\033[36mSent\033[0;34m TEMBUS KAH MANIEZZ
...
\033[0;36m =============DEWAA CREATED THIS DDOS======================"""
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;[-] DewaaTools | Api Connected [5] | Backup Server [1] | Online User [1000] | Admin: [Dewaa] | POWER : {}% [UNSTABLE]\x07".format (powerran))

		sin = input("\033[0;36m{}\033[0;34m@[DewaaC2]\033[36m--> \033[0;31m".format(nicknm)).lower()
		...
		if sinput == "cls":
			...
			try:
				...
				if running >= 1000:
					...
					print("\033[91m[-] Dewaa Generation Attack.")
					...
					print("\033[97m[/] Dewaa Generation Attack....")
